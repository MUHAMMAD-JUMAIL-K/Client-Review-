  ...
  const steps = [
    {
      ...
      icon: <Link2 className="w-6 h-6 text-[#0D333C]" />,
      tag: 'For Business',
      tagBg: 'bg-[#0D333C]/10 text-[#0D333C] border-[#0D333C]/20',
    },
    {
      num: '02',
      title: 'Share Anywhere',
      desc: 'Display your custom QR code on counter stands or share the direct link via SMS & email.',
      icon: <Share2 className="w-6 h-6 text-[#0D333C]" />,
      tag: 'For Business',
      tagBg: 'bg-[#0D333C]/10 text-[#0D333C] border-[#0D333C]/20',
    },
    {
      ...
      icon: <PenTool className="w-6 h-6 text-[#0D333C]" />,
      tag: 'For Customer',
      tagBg: 'bg-[#0D333C]/10 text-[#0D333C] border-[#0D333C]/20',
    },
    {
      ...
      icon: <ExternalLink className="w-6 h-6 text-[#0D333C]" />,
      tag: 'For Customer',
      tagBg: 'bg-[#0D333C]/10 text-[#0D333C] border-[#0D333C]/20',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#102A30] tracking-tight">
            How Alpha Tech Review Portal Works
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div
              key={step.num}
              className="bg-[#F5F7F6] border border-slate-200/80 rounded-3xl p-7 flex flex-col justify-between hover:border-[#0D333C]/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-4xl font-black text-[#0D333C]/20 group-hover:text-[#0D333C] transition-colors">
                    {step.num}
                  </span>
                  <div className="w-13 h-13 rounded-2xl bg-[#0D333C]/10 border border-[#0D333C]/20 flex items-center justify-center shadow-xs">
                    {step.icon}
                  </div>
                </div>
